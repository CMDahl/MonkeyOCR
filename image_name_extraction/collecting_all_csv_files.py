...
first = r'd:\data\HCNC\norway\biographies\storage\MonkeyOCR\digibok_2007031501007\output\extracted_all_names_with_chunks_with_biographies.csv'
...
df_next_page_portraits = pd.read_csv(r'd:\data\HCNC\norway\biographies\storage\MonkeyOCR\digibok_2007031501007\output\extracted_all_names_with_chunks_and_portraits.csv')
...
print(f"Final DataFrame saved to {output_final}")
