...
3. Portraits/images are tagged as **[FIGURE: 1.1]** in the markdown.
...
1. **Exact syntax** – Every portrait appears as **[FIGURE: figure.id]**. Search **only** for this pattern. Here figure.id is the image filename without extension, e.g., 1.1, 1.2 etc. 
