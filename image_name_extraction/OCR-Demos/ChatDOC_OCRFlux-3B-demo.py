...
content_str = result[0]['generated_text'][-1]['content']
content_data = json.loads(content_str)

# Print just the natural text
print(content_data['natural_text'])
...
Høyt vurdert egenskap? En sunn person optimisme, viljestyrke og utholdenhhet.
...
Pr. Fi/R — Lærerskoleeks. 1924, sløydlærereks. 1938, kurser. — Lærer Dverberg 1924-26, Tysfjord 1926-29, Dverberg 1929-37, Hol i Lofoten 1937-39, Glomfjord 1939-47, Stavern 1947-. — Medl.kommunestyre, form. ungdomslag, forsorgstyre og trygdekassestyre. — Int: Malerkunst.

På rette hylle? I 1924 hadde jeg alle-rede valgt en hylle. Om det var den rette, får bli andres sak å dømme om. Høyt vurdert egenskap? Det ekte og likefremme.
